...
copy /Y "%mainfolder%variants\livingworldbuildingshardDwarves.ini" "%mainfolder%source\data\ini\livingworldbuildings.ini"
copy /Y "%mainfolder%variants\livingworldbuildableunitsbrutalDwarves.inc" "%mainfolder%source\data\ini\campaigns\common\livingworldbuildableunits.inc"
