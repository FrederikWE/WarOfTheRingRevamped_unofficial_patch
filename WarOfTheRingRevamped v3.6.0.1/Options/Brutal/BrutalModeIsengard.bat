...
copy /Y "%mainfolder%variants\livingworldbuildingshardIsengard.ini" "%mainfolder%source\data\ini\livingworldbuildings.ini"
copy /Y "%mainfolder%variants\livingworldbuildableunitsbrutalIsengard.inc" "%mainfolder%source\data\ini\campaigns\common\livingworldbuildableunits.inc"
