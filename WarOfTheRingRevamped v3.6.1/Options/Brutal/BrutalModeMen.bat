...
copy /Y "%mainfolder%variants\livingworldbuildingshardMen.ini" "%mainfolder%source\data\ini\livingworldbuildings.ini"
copy /Y "%mainfolder%variants\livingworldbuildableunitsbrutalMen.inc" "%mainfolder%source\data\ini\campaigns\common\livingworldbuildableunits.inc"
