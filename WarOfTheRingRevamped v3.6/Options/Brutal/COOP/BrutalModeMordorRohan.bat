...
copy /Y "%mainfolder%variants\coop\livingworldbuildingshardMordorRohan.ini" "%mainfolder%source\data\ini\livingworldbuildings.ini"
copy /Y "%mainfolder%variants\coop\livingworldbuildableunitsbrutalMordorRohan.inc" "%mainfolder%source\data\ini\campaigns\common\livingworldbuildableunits.inc"
