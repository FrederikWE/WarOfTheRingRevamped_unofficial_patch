...
copy /Y "%mainfolder%variants\coop\livingworldbuildableunitshardMordorRivendell.inc" "%mainfolder%source\data\ini\campaigns\common\livingworldbuildableunits.inc"
