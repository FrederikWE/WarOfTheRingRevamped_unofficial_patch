...
copy /Y "%mainfolder%variants\coop\livingworldbuildableunitshardIsengardMisty.inc" "%mainfolder%source\data\ini\campaigns\common\livingworldbuildableunits.inc"
