...
copy /Y "%mainfolder%variants\coop\livingworldbuildableunitshardMirkwoodMisty.inc" "%mainfolder%source\data\ini\campaigns\common\livingworldbuildableunits.inc"
