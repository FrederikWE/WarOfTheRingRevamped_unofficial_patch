...
copy /Y "%mainfolder%variants\coop\livingworldbuildableunitshardMordorRohan.inc" "%mainfolder%source\data\ini\campaigns\common\livingworldbuildableunits.inc"
