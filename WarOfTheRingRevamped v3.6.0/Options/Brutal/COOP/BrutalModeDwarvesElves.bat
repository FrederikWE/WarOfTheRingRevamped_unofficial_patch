...
copy /Y "%mainfolder%variants\coop\livingworldbuildingshardDwarvesElves.ini" "%mainfolder%source\data\ini\livingworldbuildings.ini"
copy /Y "%mainfolder%variants\coop\livingworldbuildableunitsbrutalDwarvesElves.inc" "%mainfolder%source\data\ini\campaigns\common\livingworldbuildableunits.inc"
