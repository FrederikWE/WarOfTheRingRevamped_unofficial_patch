...
copy /Y "%mainfolder%variants\coop\livingworldbuildingshardMordorRivendell.ini" "%mainfolder%source\data\ini\livingworldbuildings.ini"
copy /Y "%mainfolder%variants\coop\livingworldbuildableunitsbrutalMordorRivendell.inc" "%mainfolder%source\data\ini\campaigns\common\livingworldbuildableunits.inc"
