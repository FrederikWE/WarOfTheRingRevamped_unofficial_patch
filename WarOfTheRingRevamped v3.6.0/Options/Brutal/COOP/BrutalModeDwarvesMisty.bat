...
copy /Y "%mainfolder%variants\coop\livingworldbuildingshardDwarvesMisty.ini" "%mainfolder%source\data\ini\livingworldbuildings.ini"
copy /Y "%mainfolder%variants\coop\livingworldbuildableunitsbrutalDwarvesMisty.inc" "%mainfolder%source\data\ini\campaigns\common\livingworldbuildableunits.inc"
