...
copy /Y "%mainfolder%variants\livingworldbuildingshardHarad.ini" "%mainfolder%source\data\ini\livingworldbuildings.ini"
copy /Y "%mainfolder%variants\livingworldbuildableunitsbrutalHarad.inc" "%mainfolder%source\data\ini\campaigns\common\livingworldbuildableunits.inc"
