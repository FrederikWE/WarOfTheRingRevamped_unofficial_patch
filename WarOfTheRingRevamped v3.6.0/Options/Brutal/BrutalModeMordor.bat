...
copy /Y "%mainfolder%variants\livingworldbuildingshardMordor.ini" "%mainfolder%source\data\ini\livingworldbuildings.ini"
copy /Y "%mainfolder%variants\livingworldbuildableunitsbrutalMordor.inc" "%mainfolder%source\data\ini\campaigns\common\livingworldbuildableunits.inc"
