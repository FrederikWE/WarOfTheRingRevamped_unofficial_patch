...
copy /Y "%mainfolder%variants\livingworldbuildingshardGuldur.ini" "%mainfolder%source\data\ini\livingworldbuildings.ini"
copy /Y "%mainfolder%variants\livingworldbuildableunitsbrutalGuldur.inc" "%mainfolder%source\data\ini\campaigns\common\livingworldbuildableunits.inc"
